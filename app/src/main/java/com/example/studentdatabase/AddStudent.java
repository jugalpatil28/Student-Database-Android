...
public class AddStudent extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    EditText editTextFirstName, editTextGrNo,editTextRollNo, editSearchValue, editTextLastName, editTextEmail, editTextMobile,editTextMiddleName,editTextCaste,editTextSkills,
            ...
            editTextCurrentAddress,editTextCurrentState,editTextCurrentCity,editTextCurrentPinCode,editTextCurrentArea;
    TextView textViewDOB;
    Button addButton, searchButton;
    Spinner spinnerBranch,spinnerShift,spinnerBatch,spinnerYear;
    ...
    String firstName, middleName , lastName, dob, grNo,year, rollNo, email, caste , skills , mobileNumber , marks10 , marks12 , feCgpa , seCgpa , teCgpa ,beCgpa,interships,branch,shift,batch,
    ...
    private void initialize()
    {
        ...
        editTextCurrentAddress = findViewById(R.id.editTextCurrentAddress);
    ...
    private void addStudent() {
        ...
        dob = textViewDOB.getText().toString().trim().toUpperCase();
        ...
        personalDetails.put("batch",batch);
        ...
        curAddress = editTextCurrentAddress.getText().toString().trim();
        ...
        if (awesomeValidation.validate() && !branch.isEmpty() && !shift.isEmpty()) {
            ...
            dataBase.collection(branch+year+batch)
                    .document(grNo)
                    .set(student)
    ...
    protected Dialog onCreateDialog(int id) {
        return new DatePickerDialog(this, datePickerListener, 2019, Calendar.MONTH, Calendar.DAY_OF_MONTH);
    }
